...
$REX['ADDON']['version']['seo42'] = '4.6.0-dev';
...
require_once($REX['INCLUDE_PATH'] . '/addons/seo42/classes/class.nav42.inc.php'); // deprecated.... dont use it any more!
...
define('SEO42_SCSSPHP_VERSION', '0.6.7');
...
$REX['ADDON']['seo42']['settings'] = array(
	...
	'favicons_dir' => '/resources/favicons/',
