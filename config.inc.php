...
$REX['ADDON']['version']['seo42'] = '2.1.0 ALPHA';
...
if ($REX['REDAXO']) {
	...
	if (rex_request('page') == 'content' && rex_request('mode') == 'edit' && rex_request('function') != 'edit' && rex_request('function') != 'add' && rex_request('function') != 'delete' && rex_request('save', 'int') != 1) {
