...
| public static | <strong>getTelLink(</strong><em>string</em> <strong>$phoneNumber</strong>, <em>string</em> <strong>$prefix=`'+'`</strong>, <em>string</em> <strong>$substitute=`'00'`</strong>)</strong> : <em>string</em><br /><em>Returns the phone number for use in link with tel: protocol. Strips whitespaces etc and converts + to 00.</em> |
