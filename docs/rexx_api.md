...
| public static | <strong>getArticle(</strong><em>int</em> <strong>$articleId</strong>)</strong> : <em>\rex_article</em><br /><em>Returns the article object from given article id.</em> |
...
| public static | <strong>getCategory(</strong><em>int</em> <strong>$id</strong>)</strong> : <em>\rex_category</em><br /><em>Returns the category by id.</em> |
...
| public static | <strong>getRootCategories(</strong><em>bool</em> <strong>$ignoreOfflines=false</strong>, <em>int</em> <strong>$clang=null</strong>)</strong> : <em>\rex_category[]</em><br /><em>Returns the root categories.</em> |
