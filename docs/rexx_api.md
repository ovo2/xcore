...
| public static | <strong>getAbsoluteMediaFile(</strong><em>string</em> <strong>$file</strong>)</strong> : <em>string</em><br /><em>Returns the absolute file with path of the given media file of resource dir.</em> |
...
| public static | <strong>getArticle(</strong><em>int</em> <strong>$articleId</strong>)</strong> : <em>\rex_article</em><br /><em>Returns the article object from article id.</em> |
...
| public static | <strong>getStrippedString(</strong><em>string</em> <strong>$string</strong>, <em>bool</em> <strong>$removeParagraphs=true</strong>)</strong> : <em>string</em><br /><em>Returns a string without p tags. Useful to remove tgas from editor output.</em> |
...
| public static | <strong>setLocale(</strong><em>string</em> <strong>$regionCode=`''`</strong>)</strong> : <em>void</em><br /><em>Sets the global locale for php. Then all php strings like month names are in the desired language.</em> |
