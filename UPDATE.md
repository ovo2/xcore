...
* Die Klasse `nav42` wurde in das neue Navigation Factory Addon überführt. Bitte den eigenen Code dementsprechend anpassen (API Änderungen im Changelog des Navigation Factory Addons).
